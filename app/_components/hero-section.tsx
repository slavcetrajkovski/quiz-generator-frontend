      ...
      <div className="container mx-auto px-4 py-10 grid lg:grid-cols-2 gap-12 items-center">
        <div className="space-y-6 text-center lg:text-left">
          ...
          <p className="text-lg sm:text-xl text-gray-600 max-w-xl mx-auto lg:mx-0">
            Quizzy helps you learn smarter, faster, and deeper with AI-crafted quizzes and insights.
          </p>
        ...
        >
          {[
            { icon: <Bot className="text-pink-600" />, title: 'AI-Powered', desc: 'Generate quizzes in seconds' },
            { icon: <BarChart className="text-blue-600" />, title: 'Smart Analytics', desc: 'See what you mastered' },
            { icon: <WandSparkles className="text-pink-600" />, title: 'Personalized', desc: 'Questions tailored to you' },
            { icon: <Star className="text-blue-600" />, title: 'Progress Tracking', desc: 'Stay motivated with goals' },
          ].map((item, i) => (
            <motion.div
              key={i}
